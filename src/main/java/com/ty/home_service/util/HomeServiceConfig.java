package com.ty.home_service.util;
...
public class HomeServiceConfig {
	...
	public Docket getDocket() {
		...
		ApiInfo apiInfo = new ApiInfo("home_service App", "HomeService App V1.0", "Version 1.2",
				"www.testyantraglobal.com", contact, "testYtantralicence@asdf", "www.testyantraterms.com", extensions);

		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.ty.home_service")).build()
